...
public:
    ...
    level(size_t num_rows, size_t num_cols, char* given_data) {
        rows = num_rows;
        columns = num_cols;
        data = given_data;
    }
    ...
    void set_columns(size_t num_cols) {
        columns = num_cols;
    }

    void set_data(char* given_data) {
        data = given_data;
    }
private:
    size_t rows = 0;
...
level* LEVEL_1 = new level(11, 19, LEVEL_1_DATA);
...
level* LEVEL_2 = new level(10, 14, LEVEL_2_DATA);
...
level* LEVEL_3 = new level(10, 17, LEVEL_3_DATA);

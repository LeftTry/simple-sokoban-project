...
public:
    merge(){
        ...
        level level1(11, 19, level_1_data);
        level level2(10, 14, level_2_data);
        level level3(10, 17, level_3_data);
